package com.avoris.hotelsearch.config;
...
public class KafkaConfig {
    ...
    ConsumerFactory<String, SearchMessage> consumerFactory() {
        final JsonDeserializer<SearchMessage> deserializer = new JsonDeserializer<>(SearchMessage.class);
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, SearchMessage> kafkaListenerContainerFactory() {
