...
class SearchKafkaConsumerTest {
    ...
    void consume_mapsMessageToDomainAndCallsUseCase() {
        ...
        final SearchMessage message = new SearchMessage("search-id", "1234aBc", "29/12/2023", "31/12/2023", List.of(30, 29, 1, 3));
        ...
        assertThat(search.normalizedKey().value()).isEqualTo("1234aBc|29/12/2023|31/12/2023|1,3,29,30");
    }
}
